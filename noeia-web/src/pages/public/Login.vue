...
<template>
  <div class="min-h-screen flex flex-col items-center justify-center bg-white p-4">
    <!-- Logo -->
    <div class="mb-12 flex flex-col items-center gap-4 animate-fade-in-up">
        <div class="w-12 h-12 bg-primary-600 rounded-xl flex items-center justify-center text-white font-bold text-2xl shadow-lg shadow-primary-200">N</div>
        <h1 class="text-2xl font-bold text-slate-900">Log in to Noeia</h1>
    </div>
